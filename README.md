...
**My Portfolio Project!** is my second project at Microverse, in this project I talk about myself as a programmer and I try to allow recruiters to get to know my work.
...
- **This repository includes html and css files used to make the portfolio**
...
- Step 2: Once you have installed git you can clone this project using the command below:
  ```
  git clone https://github.com/arnoldnekemiah/portfolio-micro.git
  ```
